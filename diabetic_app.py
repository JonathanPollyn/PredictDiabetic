...
skinthickness = st.sidebar.number_input('SkinThickness (mm)', min_value=0.0, max_value=1000.0, value=0.0)
insulin = st.sidebar.number_input('Insulin (microU/mL)', min_value=0.0, max_value=1000.0, value=0.0)
